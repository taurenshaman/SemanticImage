...
如果你在Silverlight中用到了ImageTools项目（http://imagetools.codeplex.com/），可以看考这个讨论：
If you are using ImageTools project(http://imagetools.codeplex.com/) in Silverlight, please reference this discussion:
...
[SampleCode201211]
用到了pngcs项目（http://code.google.com/p/pngcs/）。
